...
public class PlayerManager extends JFrame {
  ...
  private void tabbedPaneMgrStateChanged(ChangeEvent e) {
  ...
  private void tabbedPaneMgrFocusGained(FocusEvent e) {
    if (this.player == null) return;
    int currentTable = ((JTabbedPane)e.getSource()).getSelectedIndex();
    flashTable(currentTable);
  }
  ...
  private void initComponents() {
    ...
    //======== tabbedPaneMgr ========
    {
      tabbedPaneMgr.setTabLayoutPolicy(JTabbedPane.SCROLL_TAB_LAYOUT);
      tabbedPaneMgr.setPreferredSize(null);
      tabbedPaneMgr.setMaximumSize(new Dimension(0, 173));
      tabbedPaneMgr.setMinimumSize(null);
      tabbedPaneMgr.addFocusListener(new FocusAdapter() {
        @Override
        public void focusGained(FocusEvent e) {
          tabbedPaneMgrFocusGained(e);
        }
      });
      tabbedPaneMgr.addChangeListener(e -> tabbedPaneMgrStateChanged(e));
      ...
      tabbedPaneMgr.addTab(bundle.getString("RelicMgr"), scrollPane3);
      ...
      tabbedPaneMgr.addTab(bundle.getString("PotionMgr"), scrollPane2);
      ...
      tabbedPaneMgr.addTab(bundle.getString("HandCardMgr"), scrollPane4);
    }
    contentPane.add(tabbedPaneMgr, new GridBagConstraints(0, 1, 2, 1, 0.0, 0.0,
       GridBagConstraints.CENTER, GridBagConstraints.BOTH,
       new Insets(5, 5, 5, 5), 0, 0
    ));
    pack();
